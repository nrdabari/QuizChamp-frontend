  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-purple-200 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-purple-800 mb-6">Exercise List</h1>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {exercises.map((ex) => (
            ...
            >
              <div>
                <h2 className="text-xl font-bold text-purple-700">{ex.subject}</h2>
                <p className="text-sm text-gray-600">Class {ex.class}</p>
              </div>
              <div className="text-gray-700">
                <p><strong>Chapter:</strong> {ex.chapter || <em>—</em>}</p>
